...
(function ($) {
  jQuery.fn.nanoGallery = function (options) {
    var settings = $.extend(true, {
      ...
      i18n : {
        'breadcrumbHome' : 'Галерея', 'breadcrumbHome_FR' : 'Galeries',
        'paginationPrevious' : 'Назад', 'paginationPrevious_FR' : 'Pr&eacute;c&eacute;dent', 'paginationPrevious_DE' : 'Zur&uuml;ck', 'paginationPrevious_IT' : 'Indietro',
        'paginationNext' : 'Далее', 'paginationNext_FR' : 'Suivant', 'paginationNext_DE' : 'Weiter', 'paginationNext_IT' : 'Avanti',
...
g_thumbSize = 0,
  ...
  g_colorScheme_lightBackground = {
    ...
    thumbnail : { background:'#000', border:'1px solid #FFF', labelBackground:'rgba(34, 34, 34, 0.85)', titleColor:'#fff', titleShadow:'', descriptionColor:'#eee', descriptionShadow:''}
  };
