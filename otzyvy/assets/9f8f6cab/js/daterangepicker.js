...
!function ($) {
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        if (hasOptions) {
            ...
            if (typeof options.beginFormatLabel == 'string') {
                this.beginFormatLabel = options.beginFormatLabel;
            }

            if (typeof options.endFormatLabel == 'string') {
                this.endFormatLabel = options.endFormatLabel;
            }
            ...
            if (typeof options.locale.daysOfWeek == 'array') {
                this.locale.daysOfWeek = options.locale.daysOfWeek;
            }

            //checking start day of week 0 = Sunday, 1 = Monday
            if (typeof options.startDayOfWeek == 'number') {
                this.startDayOfWeek = options.startDayOfWeek;
            }
    ...
    DateRangePicker.prototype = {
        ...
        notify: function () {
            ...
            if (this.element.is('input')) {
                this.element.val(this.beginFormatLabel + this.startDate.toString(this.format) + this.endFormatLabel + this.endDate.toString(this.format));
            }
            this.cb(this.startDate, this.endDate);
        },
        ...
        clickRange: function (e) {
            ...
            if (label == this.locale.customRangeLabel) {
                ...
                $('input#dateId').attr('value', label.toString());
