		...
		<tr>
			...
			<td>
				...
				<select class="type">
					...
					<option value="2"<?php echo $selected['options']['type'][2]; ?>>Наливной 3D пол в ванной, 10 м²</option>
					<option value="3"<?php echo $selected['options']['type'][3]; ?>>Капитальный ремонт 2-комнатной картиры, 54 м²</option>
					<option value="4"<?php echo $selected['options']['type'][4]; ?>>Офисное помещение, 900 м²</option>
					<option value="5"<?php echo $selected['options']['type'][5]; ?>>Укладка теплого пола под ламинат в гостиной, 10 м²</option>
					<option value="6"<?php echo $selected['options']['type'][6]; ?>>Укладка ламината, 18 м²</option>
				</select>
			</td>
		</tr>
	</table>
...
<div class="result">
	...
	<div class="services">
		<div class="task">
			<strong>Описание проекта:</strong> Монтаж теплого пола 10 м<sup>2</sup>, в гостиной 21 м<sup>2</sup>. Остальная площадь занята мебелью. 
		</div>
		<table>
			<tr>
				<td>Подготовка поверхности</td>
