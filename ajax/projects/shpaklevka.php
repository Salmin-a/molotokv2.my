		...
		<tr>
			...
			<td>
				...
				<select class="type">
					...
					<option value="2"<?php echo $selected['options']['type'][2]; ?>>Ремонт после затопления, 12 м²</option>
                    <option value="3"<?php echo $selected['options']['type'][3]; ?>>Потолок в комнате из ГКЛ, 15 м²</option>
                    <option value="4"<?php echo $selected['options']['type'][4]; ?>>В комнате, ГКЛ, двухуровневый, 18 м²</option>
				</select>
			</td>
		</tr>
	</table>
...
<div class="result">
    ...
    <div class="services">
		<div class="task">
			<strong>Описание проекта:</strong> Квартира с муниципальным ремонтом, после затопления соседями. Соседи востонавливали в исходное состояние.
		</div>
		<table>
			<tr>
				<td>Подготовка поверхности (зачистка от старой краски, обоев)</td>
