	...
	<table width="100%">
		...
		<tr>
			...
			<td>
				...
				?>
				<select class="type">
					<option value="1"<?php echo $selected['options']['type'][1]; ?>>Изготовление 3D пола в ванной, 10 м²</option>
					<option value="2"<?php echo $selected['options']['type'][2]; ?>>Укладка паркетной доски в зале новостройки, 24 м²</option>
					<option value="3"<?php echo $selected['options']['type'][3]; ?>>Теплый пол в гостинной, 10 м²</option>
					<option value="4"<?php echo $selected['options']['type'][4]; ?>>Ремонт пола в офисном помещении, 900 м²</option>
				</select>
			</td>
		</tr>
	</table>
