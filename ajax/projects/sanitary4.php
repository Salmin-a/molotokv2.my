		...
		<tr>
			...
			<td>
				...
				<select class="type">
					...
					<option value="3"<?php echo $selected['options']['type'][3]; ?>>Замена батарей отопления в 2-х комнатах</option>
				</select>
			</td>
		</tr>
...
<div class="result">
	...
	<div class="services">
		<table>
			...
			<tr>
				<td>Установка радиатора отопления до 7 секций (батарии) с 2-мя шаровыми кранами</td>
				<td class="unit">3 шт.</td>
			</tr>
			<tr>
				<td>Подключение к системе с использованием старого места врезки</td>
				<td class="unit"></td>
			</tr>
		</table>
	</div>
